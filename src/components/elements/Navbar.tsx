            ...
            <nav className="w-full flex justify-between gap-6 relative">
             ...
             >
                <ul className="border-t border-box-border lg:border-t-0 px-6 lg:px-0
                 ...
                 text-lg text-headding-2 w-full lg:justify-center lg:items-center">
                    {navitems.map((item,key) => (
                <NavItem href={item.href} text={item.text} key={key} />
                    ))}
                </ul>
                <div className="lg:min-w-max flex items-center sm:w-max w-full pb-6 lg:pb-0 border-b border-box-border lg:border-b-0
                 px-6 lg:px-0"
                 >
